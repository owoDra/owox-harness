...
description: Use when adding or revising reusable implementation or operation patterns.
argument-hint: "goal=<pattern change> path=<target file>"
---
## Purpose

Capture repeatable patterns so future implementation work stays consistent.
